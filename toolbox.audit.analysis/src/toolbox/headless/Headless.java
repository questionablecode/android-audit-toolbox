	...
	private IProject importAPK(File apk, String projectName) {
		...
		if(apk.exists()){
			try {
				...
				// TODO: Double check the 3rd and 4th file arguments
				// I suspect argument 3 is the apk path and argument 4 is the path the apk resource table reference files
				ApkToJimple.createAndroidBinaryProject(projectName, new Path(outputDir), apk, null, new NullProgressMonitor());
